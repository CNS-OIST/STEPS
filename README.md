...
----------------------
1. To use one of the parallel SSA solvers: MPI libraries (e.g. [MPICH](https://www.mpich.org/))
...
Detailed guides for the new API can be found in the [documentation](http://steps.sourceforge.net/manual/).
...
4. [h5py](https://docs.h5py.org/en/stable/index.html)
5. [mpi4py](https://mpi4py.readthedocs.io/en/stable/mpi4py.html) (if MPI is installed)
