...
typedef RaftEndocytosis* RaftEndocytosisP;
typedef std::map<std::string, RaftEndocytosisP> RaftEndocytosisPMap;
typedef RaftEndocytosisPMap::iterator RaftEndocytosisPMapI;
typedef RaftEndocytosisPMap::const_iterator RaftEndocytosisPMapCI;
typedef std::vector<RaftEndocytosisP> RaftEndocytosisPVec;
typedef RaftEndocytosisPVec::iterator RaftEndocytosisPVecI;
typedef RaftEndocytosisPVec::const_iterator RaftEndocytosisPVecCI;
...
class RaftEndocytosis {
  public:
    ...
    /// \param raftsys Pointer to the parent raft system.
