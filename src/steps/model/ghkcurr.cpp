...
GHKcurr::GHKcurr(std::string const& id,
    ...
    , pVshift(vshift) {
    ArgErrLogIf(pSurfsys == nullptr, "No surfsys provided to GHKcurr initializer function");

    ArgErrLogIf(pChanState == nullptr, "No channel state provided to GHKcurr initializer function");

    ArgErrLogIf(pIon == nullptr, "No ion provided to GHKcurr initializer function");
