...
class Volsys {
  public:
    ...
    /// \return Pointer to the vesicle binding object.
    ...
    ///         stored in the system.
    std::vector<VesBind*> getAllVesBinds() const;
    ...
    /// \return Pointer to the vesicle unbinding object.
    ...
    ///         stored in the system.
    std::vector<VesUnbind*> getAllVesUnbinds() const;
    ...
    ///
    /// \param reac Pointer to the vesicle binding reaction.
    ...
    ///
    /// \param reac Pointer to the vesicle unbinding reaction.
    ...
    /// Delete a species.
    ///
    /// \param Pointer to the link species.
