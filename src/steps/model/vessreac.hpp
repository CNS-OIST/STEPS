...
class VesSReac {
  public:
    ...
    VesSReac(const VesSReac&) = delete;
    VesSReac& operator=(const VesSReac&) = delete;
    ...
    util::flat_set<LinkSpec*> getAllLinkSpecs() const;
...
inline bool operator<(const VesSReac& lhs, const VesSReac& rhs) {
