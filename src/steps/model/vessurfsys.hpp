...
class VesSurfsys {
  public:
    ...
    VesSurfsys(const VesSurfsys&) = delete;
    VesSurfsys& operator=(const VesSurfsys&) = delete;
    ...
    ///
    /// \param Reference to the exocytosis.
    ...
    ///
    /// \param vessreac Reference to the vesicle surface reaction.
    ...
    ///
    /// \param vessdiff Reference to the vesicle surface diffusion.
    ...
    /// \return Reference to the vesicle surface diffusion rule.
