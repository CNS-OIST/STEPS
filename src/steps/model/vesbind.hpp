...
typedef VesBind* VesBindP;
typedef std::map<std::string, VesBindP> VesBindPMap;
typedef VesBindPMap::iterator VesBindPMapI;
typedef VesBindPMap::const_iterator VesBindPMapCI;
typedef std::vector<VesBindP> VesBindPVec;
typedef VesBindPVec::iterator VesBindPVecI;
typedef VesBindPVec::const_iterator VesBindPVecCI;
...
class VesBind {
  public:
    ...
    // std::vector<LinkSpec *> getAllLinkSpecs(void) const;
