...
typedef Exocytosis* ExocytosisP;
typedef std::map<std::string, ExocytosisP> ExocytosisPMap;
typedef ExocytosisPMap::iterator ExocytosisPMapI;
typedef ExocytosisPMap::const_iterator ExocytosisPMapCI;
typedef std::vector<ExocytosisP> ExocytosisPVec;
typedef ExocytosisPVec::iterator ExocytosisPVecI;
typedef ExocytosisPVec::const_iterator ExocytosisPVecCI;
...
class Exocytosis {
  public:
    ...
    /// Return a pointer to the parent vesicle surface system.
    ///
    ...
    /// Return if this is a kiss-n-run or not.
    ///
    /// \return Bool.
