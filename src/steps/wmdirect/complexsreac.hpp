...
#include "solver/complexsreacdef.hpp"
...
class ComplexSReac: public KProc {
  public:
    ////////////////////////////////////////////////////////////////////////
    // OBJECT CONSTRUCTION & DESTRUCTION
    ////////////////////////////////////////////////////////////////////////

    ComplexSReac(solver::ComplexSReacdef& rdef, Patch& patch);
    ~ComplexSReac() override;
    ...
    bool depComplexPatch(solver::complex_global_id gidx,
                         solver::complex_substate_id sus,
    ...
    solver::ComplexSReacdef& defcsr() const noexcept override {
        return pComplexSReacdef;
    }
  ...
  private:
    ...
    solver::ComplexSReacdef& pComplexSReacdef;
    Patch& pPatch;
    ...
    mutable std::map<model::ComplexLocation,
                     std::map<solver::complex_global_id, ComplexLHSCandidates>>
        candidates;
