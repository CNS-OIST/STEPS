...
STEPS_EXTERN double permeability(double G, double V, int z, double T, double iconc, double oconc);
...
STEPS_EXTERN double GHKcurrent(double P, double V, int z, double T, double iconc, double oconc);
