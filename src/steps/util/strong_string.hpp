 ...
 */
template <typename> class strong_string : public std::string {
public:
  using std::string::string;
  explicit strong_string(const std::string &s) : std::string(s.c_str()){};
};
 ...
 */
template <typename T> struct hash<::steps::util::strong_string<T>> {
public:
