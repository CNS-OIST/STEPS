...
public:
  ...
  constexpr OptionalNum() noexcept : value_(none_value()){};

  constexpr OptionalNum(NoneType) noexcept : value_(none_value()){};
  ...
  constexpr bool has_value() const noexcept { return value_ != none_value(); }
  ...
  static constexpr T none_value() noexcept { return NoneValue; }
