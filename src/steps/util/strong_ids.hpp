 ...
 */
template <typename StrongIds> struct strong_ids_iterator {
  ...
  inline strong_ids_iterator(const StrongIds &strong_ids,
 ...
 *
 * Rely on Omega_h::Read container internally so only the following integral
 * types are supported: I8, I32, I64, Real \tparam StrongId Concrete
 * zee:strong_id<...> type
 */
template <typename StrongId> struct strong_ids {
  ...
  inline strong_ids(std::initializer_list<data_type> ids,
...
template <typename StrongId>
inline typename strong_ids<StrongId>::value_type
strong_ids<StrongId>::at(size_type pos) const {
...
template <typename StrongId>
inline typename strong_ids<StrongId>::value_type
    strong_ids<StrongId>::operator[](size_type pos) const noexcept {
  return value_type(ids_[pos]);
}

template <typename StrongId>
inline typename strong_ids<StrongId>::value_type
strong_ids<StrongId>::front() const noexcept {
  return value_type(ids_.first());
}

template <typename StrongId>
inline typename strong_ids<StrongId>::value_type
strong_ids<StrongId>::back() const noexcept {
  return value_type(ids_.last());
}

template <typename StrongId>
inline const typename Omega_h::Read<typename StrongId::value_type> &
strong_ids<StrongId>::data() const noexcept {
  return ids_;
}

template <typename StrongId>
inline typename strong_ids<StrongId>::iterator_type
strong_ids<StrongId>::begin() const noexcept {
  return iterator_type(*this, 0);
}

template <typename StrongId>
inline typename strong_ids<StrongId>::iterator_type
strong_ids<StrongId>::end() const noexcept {
  return iterator_type(*this, size());
}

template <typename StrongId>
inline typename strong_ids<StrongId>::size_type
strong_ids<StrongId>::size() const noexcept {
  return ids_.size();
}
...
inline strong_ids_iterator<StrongIds>::strong_ids_iterator(
    const StrongIds &strong_ids, size_type pos) noexcept
    : strong_ids_(strong_ids), pos_(pos) {}

template <typename StrongIds>
inline strong_ids_iterator<StrongIds>::strong_ids_iterator(
    const strong_ids_iterator &other) noexcept
    : strong_ids_(other.strong_ids_), pos_(other.pos_) {}

template <typename StrongIds>
inline strong_ids_iterator<StrongIds> &
strong_ids_iterator<StrongIds>::operator++() noexcept {
  ++pos_;
  return *this;
}
...
template <typename StrongIds>
inline strong_ids_iterator<StrongIds>
strong_ids_iterator<StrongIds>::operator++(int) noexcept {
...
template <typename StrongIds>
inline typename strong_ids_iterator<StrongIds>::value_type
    strong_ids_iterator<StrongIds>::operator*() const noexcept {
  return strong_ids_[pos_];
}

template <typename StrongIds>
inline bool strong_ids_iterator<StrongIds>::operator==(
    const strong_ids_iterator &other) const noexcept {
