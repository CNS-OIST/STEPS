...
////////////////////////////////////////////////////////////////////////////////
/*
bool VDepSReac::depSpecTet(solver::spec_global_id  gidx, WmVol *
tet)
{
...
bool VDepSReac::depSpecTri(solver::spec_global_id  gidx, Tri *
triangle)
{
...
double VDepSReac::rate(mpi::tetopsplit::TetOpSplitP* solver) {
    if (inactive()) {
        return 0.0;
    }
...
void VDepSReac::apply(const rng::RNGptr& /*rng*/, double dt, double simtime, double period) {
