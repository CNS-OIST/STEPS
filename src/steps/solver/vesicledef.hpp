...
class Vesicledef {
  public:
    ...
    /// \param d Pointer to the associated Vesicle object.
  ...
  public:
    ...
    /// Return a pointer to reaction definition object (type VesSReacdef)
  ...
  public:
    ...
    /// Return a pointer to reaction definition object (type Exocytosisdef)
    /// specified by local index.
    ...
    /// information??
    Statedef* statedef() const noexcept {
        return pStatedef;
    }
  ...
  private:
    ...
    std::set<std::string> pVssys;

    ////////////////////////////////////////////////////////////////////////
    // DATA: SPECIES
    ////////////////////////////////////////////////////////////////////////

    /// Number of species embedded in vescile surface (_V)
    ///
    uint pSpecsN_V;
