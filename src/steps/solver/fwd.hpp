...
using sreac_charge_local_id = util::strong_id<index_t, struct sreac_charge_local_id_trait>;
...
using vdepsreac_charge_local_id = util::strong_id<index_t, struct vdepsreac_charge_local_id_trait>;
...
using path_global_id = util::strong_id<index_t, struct path_global_id_trait>;
using path_edge_global_id = util::strong_id<index_t, struct path_edge_global_id_trait>;
