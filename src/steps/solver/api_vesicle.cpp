...
std::vector<vesicle_individual_id> API::getAllVesicleIndices() const {
    return _getAllVesicleIndices();
}

////////////////////////////////////////////////////////////////////////////////

std::vector<vesicle_individual_id> API::getAllVesicleIndicesOnPath() const {
    return _getAllVesicleIndicesOnPath();
}
...
std::vector<vesicle_individual_id> API::_getAllVesicleIndices() const {
    throw NotImplErr();
}

////////////////////////////////////////////////////////////////////////////////

std::vector<vesicle_individual_id> API::_getAllVesicleIndicesOnPath() const {
    throw NotImplErr();
}
