...
class API {
  public:
    ...
    void setCompSingleVesiclePos(std::string const& c,
                                 std::string const& v,
                                 vesicle_individual_id ves_unique_index,
  ...
  protected:
    ...
    virtual std::vector<double> _getSingleVesiclePos(vesicle_global_id vidx,
                                                     vesicle_individual_id ves_unique_index) const;
    virtual void _setCompSingleVesiclePos(comp_global_id cidx,
                                          vesicle_global_id vidx,
                                          vesicle_individual_id ves_unique_index,
                                          const std::vector<double>& pos,
                                          bool force = false);
  ...
  public:
    ...
    inline solver::Statedef& statedef() const noexcept {
        return *pStatedef;
    }
