...
class Patchdef {
  ...
  public:
    ...
    /// Return a pointer to reaction definition object (type Endocytosisdef)
    /// specified by local index.
    ...
    /// Return a pointer to reaction definition object (type RaftGendef)
    /// specified by local index.
  ...
  private:
    ...
    // A pointer to the wm::Patch object this object defines.
    // wm::Patch                  * pPatch;
    ...
    std::vector<EndocyticZonedef*> pEndocyticZonesdefs;
