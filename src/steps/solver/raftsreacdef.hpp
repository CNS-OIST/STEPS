...
class RaftSReacdef {
  public:
    ...
    /// \param rsr Pointer to the RaftSReac object.
    ...
    inline raftsreac_global_id gidx(void) const noexcept {
        return pIdx;
    }
  ...
  private:
    ...
    model::SpecPVec pRslhs;
    model::SpecPVec pIlhs;

    model::SpecPVec pOrhs;
    model::SpecPVec pSrhs;
    model::SpecPVec pRsrhs;
    model::SpecPVec pIrhs;

    model::SpecPVec pRsdep;
    model::SpecPVec pAntiRsdep;
