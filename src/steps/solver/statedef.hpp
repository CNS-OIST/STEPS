...
class Statedef {
  public:
    ...
    /// \exception Throw exception if geometry does not contain comp with this
    /// identifier.
    comp_global_id getCompIdx(wm::Comp* comp) const;
    ...
    /// \exception Throw exception if geometry does not contain patch with this
    /// identifier.
    patch_global_id getPatchIdx(wm::Patch* patch) const;
    ...
    spec_global_id getSpecIdx(model::Spec* spec) const;
    ...
    /// \exception Throw exception if model does not contain reac with this
    /// identifier.
    reac_global_id getReacIdx(model::Reac* reac) const;
    ...
    /// \exception Throw exception if model does not contain sreac with this
    /// identifier.
    sreac_global_id getSReacIdx(model::SReac* sreac) const;
    ...
    diff_global_id getDiffIdx(model::Diff* diff) const;
    ...
    /// \exception Throw exception if model does not contain this diff.
    surfdiff_global_id getSurfDiffIdx(model::Diff* diff) const;
    ...
    vdepsreac_global_id getVDepSReacIdx(model::VDepSReac* vdepsreac) const;
    ...
    ohmiccurr_global_id getOhmicCurrIdx(model::OhmicCurr* ohmiccurr) const;
    ...
    ghkcurr_global_id getGHKcurrIdx(model::GHKcurr* ghkcurr) const;
    ...
    /// Return pointer to DiffBoundarydef object specified by global index
    /// argument.
    ///
    ...
    /// this identifier.
    diffboundary_global_id getDiffBoundaryIdx(tetmesh::DiffBoundary* diffb) const;
    ...
    /// Return pointer to SDiffBoundarydef object specified by global index
    /// argument.
    ///
    ...
    /// \exception Throw exception if geometry does not contain sdiff boundary
    /// with this identifier.
    sdiffboundary_global_id getSDiffBoundaryIdx(tetmesh::SDiffBoundary* sdiffb) const;
    ...
    /// Return pointer to LinkSpecdef object specified by global index argument.
    ///
    ...
    linkspec_global_id getLinkSpecIdx(model::LinkSpec* spec) const;
    ...
    /// Return pointer to Vesicledef object specified by global index argument.
    ///
    ...
    vesicle_global_id getVesicleIdx(model::Vesicle* vesicle) const;
    ...
    /// Return pointer to Raftdef object specified by global index argument.
    ///
    ...
    raft_global_id getRaftIdx(model::Raft* raft) const;
    ...
    /// Return pointer to VesBinddef object specified by global index argument.
    ///
    ...
    /// argument.
    ///
    /// \param vesbind Pointer to the vesicle binding reaction object.
    /// \exception Throw exception if model does not contain vesbind with this
    /// identifier.
    vesbind_global_id getVesBindIdx(model::VesBind* vesbind) const;
    ...
    /// Return pointer to VesUnbinddef object specified by global index argument.
    ///
    ...
    /// argument.
    ///
    /// \param vesbind Pointer to the vesicle unbinding reaction object.
    /// \exception Throw exception if model does not contain vesunbind with this
    /// identifier.
    vesunbind_global_id getVesUnbindIdx(model::VesUnbind* vesunbind) const;
    ...
    /// Return pointer to VesSReacdef object specified by global index argument.
    ///
    ...
    /// argument.
    ///
    /// \param vessreac Pointer to the surface reaction object..
    /// \exception Throw exception if model does not contain vessreac with this
    /// identifier.
    vessreac_global_id getVesSReacIdx(model::VesSReac* vessreac) const;
    ...
    /// Return pointer to RaftSReacdef object specified by global index argument.
    ///
    ...
    /// argument.
    ///
    /// \param raftsreac Pointer to the surface reaction object..
    /// \exception Throw exception if model does not contain raftsreac with this
    /// identifier.
    raftsreac_global_id getRaftSReacIdx(model::RaftSReac* raftsreac) const;
    ...
    /// Return pointer to RaftEndocytosisdef object specified by global index
    /// argument.
    ///
    ...
    /// argument.
    ///
    /// \param endocyt Pointer to the endocytotic reaction object..
    /// \exception Throw exception if model does not contain endocytosis with this
    /// identifier.
    raftendocytosis_global_id getRaftEndocytosisIdx(model::RaftEndocytosis* endocyt) const;
    ...
    /// Return pointer to pRaftGendefs object specified by global index argument.
    ///
    ...
    ///
    /// \param endocyt Pointer to the raft genesis object..
    /// \exception Throw exception if model does not contain raft genesis with
    /// this identifier.
    raftgen_global_id getRaftGenIdx(model::RaftGen* raftgen) const;
    ...
    /// Return pointer to pRaftDisdefs object specified by global index argument.
    ///
    ...
    ///
    /// \param endocyt Pointer to the raft dissolution object..
    /// \exception Throw exception if model does not contain raft dissolution with
    /// this identifier.
    raftdis_global_id getRaftDisIdx(model::RaftDis* raftdis) const;
    ...
    /// Return pointer to Endocytosisdef object specified by global index
    /// argument.
    ///
    /// \param gidx Global index of the endocytotic reaction.
    ...
    /// \exception Throw exception if model does not contain endocytosis with this
    /// identifier.
    endocytosis_global_id getEndocytosisIdx(model::Endocytosis* endocyt) const;
    ...
    /// Return pointer to Exocytosisdef object specified by global index argument.
    ///
    ...
    /// argument.
    ///
    /// \param exocyt Pointer to the exocytotic reaction object..
    /// \exception Throw exception if model does not contain exocytosis with this
    /// identifier.
    exocytosis_global_id getExocytosisIdx(model::Exocytosis* exocyt) const;
    ...
    /// Return pointer to VesSDiffdefs object specified by global index argument.
    ///
    ...
    /// argument.
    ///
    /// \param diff Pointer to the vesicle surface diffusion object.
    /// \exception Throw exception if model does not contain this diff.
    vessdiff_global_id getVesSDiffIdx(model::VesSDiff* vsdiff) const;
  ...
  private:
    ...
    util::strongid_vector<spec_global_id, Specdef*> pSpecdefs;
    util::strongid_vector<chan_global_id, Chandef*> pChandefs;
    util::strongid_vector<comp_global_id, Compdef*> pCompdefs;
    util::strongid_vector<patch_global_id, Patchdef*> pPatchdefs;
    util::strongid_vector<reac_global_id, Reacdef*> pReacdefs;
    util::strongid_vector<sreac_global_id, SReacdef*> pSReacdefs;
    util::strongid_vector<diff_global_id, Diffdef*> pDiffdefs;
    util::strongid_vector<surfdiff_global_id, SurfDiffdef*> pSurfDiffdefs;
    util::strongid_vector<vdepsreac_global_id, VDepSReacdef*> pVDepSReacdefs;
    util::strongid_vector<ohmiccurr_global_id, OhmicCurrdef*> pOhmicCurrdefs;
    util::strongid_vector<ghkcurr_global_id, GHKcurrdef*> pGHKcurrdefs;
    util::strongid_vector<diffboundary_global_id, DiffBoundarydef*> pDiffBoundarydefs;
    util::strongid_vector<sdiffboundary_global_id, SDiffBoundarydef*> pSDiffBoundarydefs;

    util::strongid_vector<linkspec_global_id, LinkSpecdef*> pLinkSpecdefs;
    util::strongid_vector<vesicle_global_id, Vesicledef*> pVesicledefs;
    util::strongid_vector<raft_global_id, Raftdef*> pRaftdefs;
    util::strongid_vector<endocytosis_global_id, Endocytosisdef*> pEndocytosisdefs;
    util::strongid_vector<exocytosis_global_id, Exocytosisdef*> pExocytosisdefs;
    util::strongid_vector<vesbind_global_id, VesBinddef*> pVesBinddefs;
    util::strongid_vector<vesunbind_global_id, VesUnbinddef*> pVesUnbinddefs;
    util::strongid_vector<vessdiff_global_id, VesSDiffdef*> pVesSDiffdefs;
    util::strongid_vector<vessreac_global_id, VesSReacdef*> pVesSReacdefs;
    util::strongid_vector<raftsreac_global_id, RaftSReacdef*> pRaftSReacdefs;
    util::strongid_vector<raftendocytosis_global_id, RaftEndocytosisdef*> pRaftEndocytosisdefs;
    util::strongid_vector<raftgen_global_id, RaftGendef*> pRaftGendefs;
    util::strongid_vector<raftdis_global_id, RaftDisdef*> pRaftDisdefs;
};
