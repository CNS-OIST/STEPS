...
# ----------------------------------------------------------------------------------------------------------------------
    ...
    def getCompComplexCount(self, str c, str cmplx, f):
        """
        Returns the number of molecules of a complex with identifier string cmplx
        ...
        Syntax::
            ...
            getCompComplexCount(comp, cmplx, filt)
        ...
        """
        return self.ptr().getCompComplexCount(to_std_string(c), to_std_string(cmplx), _get_filters(f))

    def setCompComplexCount(self, str c, str cmplx, i, double n):
        """
        Set the number of molecules of a complex with identifier string cmplx
        ...
        Syntax::
            ...
            setCompComplexCount(comp, cmplx, init, nspec)
        ...
        """
        self.ptr().setCompComplexCount(to_std_string(c), to_std_string(cmplx), _get_filters(i), n)

    def getCompComplexAmount(self, str c, str cmplx, f):
        """
        Returns the amount (in mols) of complex with identifier string cmplx
        matching filter filt in compartment with identifier string comp.
        ...
        Syntax::
            ...
            getCompComplexAmount(comp, cmplx, filt)
        ...
        """
        return self.ptr().getCompComplexAmount(to_std_string(c), to_std_string(cmplx), _get_filters(f))

    def setCompComplexAmount(self, str c, str cmplx, i, double a):
        """
        Set the amount (in mols) of complex with identifier string cmplx in state init
        in compartment with identifier string comp.
        ...
        Syntax::
            ...
            setCompComplexAmount(comp, cmplx, init, amount)
        ...
        """
        self.ptr().setCompComplexAmount(to_std_string(c), to_std_string(cmplx), _get_filters(i), a)

    def getCompComplexConc(self, str c, str cmplx, f):
        """
        Returns the concentration (in Molar units) of complex with identifier string cmplx 
        matching filter filt in compartment with identifier string comp.
        ...
        Syntax::
            ...
            getCompComplexConc(comp, cmplx, filt)
        ...
        """
        return self.ptr().getCompComplexConc(to_std_string(c), to_std_string(cmplx), _get_filters(f))

    def setCompComplexConc(self, str c, str cmplx, i, double conc):
        """
        Sets the concentration (in Molar units) of complex with identifier string cmplx
        in state init in compartment with identifier string comp to conc. 
        In a discrete solver the continuous concentration is converted to a discrete
        number of molecules.
        ...
        Syntax::
            ...
            setCompComplexConc(comp, cmplx, init, conc)
        ...
        """
        self.ptr().setCompComplexConc(to_std_string(c), to_std_string(cmplx), _get_filters(i), conc)

    def getCompComplexSUSCount(self, str c, str cmplx, f, uint m):
        """
        Returns the number of subunits in state m of a complex with identifier string cmplx
        matching filter filt in compartment with identifier string comp.
        ...
        Syntax::
            ...
            getCompComplexCount(comp, cmplx, filt, m)
        ...
        """
        return self.ptr().getCompComplexSUSCount(to_std_string(c), to_std_string(cmplx), _get_filters(f), m)

    def getCompComplexSUSConc(self, str c, str cmplx, f, uint m):
        """
        Returns the concentration of subunits in state m of a complex with identifier string cmplx
        matching filter filt in compartment with identifier string comp.
        ...
        Syntax::
            ...
            getCompComplexConc(comp, cmplx, filt, m)
        ...
        """
        return self.ptr().getCompComplexSUSConc(to_std_string(c), to_std_string(cmplx), _get_filters(f), m)

    def getCompComplexSUSAmount(self, str c, str cmplx, f, uint m):
        """
        Returns the amount of subunits in state m of a complex with identifier string cmplx
        matching filter filt in compartment with identifier string comp.
        ...
        Syntax::
            ...
            getCompComplexAmount(comp, cmplx, filt, m)
        ...
        """
        return self.ptr().getCompComplexSUSAmount(to_std_string(c), to_std_string(cmplx), _get_filters(f), m)
    ...
    def getCompComplexReacExtent(self, str c, str r):
        """
        Return the extent of complex reaction with identifier string reac in compartment with 
        identifier string comp, that is the number of times the complex reaction has occurred up 
        to the current simulation time. 

        Note: in a mesh-based simulation (i.e. Tetexact), returns the sum of the complex reaction 
        extents in all tetrahedral elements of the compartment.
        ...
        """
        return self.ptr().getCompComplexReacExtent(to_std_string(c), to_std_string(r))
    ...
    def getPatchComplexCount(self, str patch, str cmplx, f):
        """
        Returns the number of molecules of a complex with identifier string cmplx
        matching filter filt in patch with identifier string patch.

        In a mesh-based simulation this is the combined count from 
        all tetrahedral elements in the patch.

        Syntax::
            
            getPatchComplexCount(patch, cmplx, filt)
        ...
        """
        return self.ptr().getPatchComplexCount(to_std_string(patch), to_std_string(cmplx), _get_filters(f))

    def setPatchComplexCount(self, str c, str cmplx, i, double n):
        """
        Set the number of molecules of a complex with identifier string cmplx
        ...
        Syntax::
            ...
            setPatchComplexCount(patch, cmplx, init, nspec)
        ...
        """
        self.ptr().setPatchComplexCount(to_std_string(c), to_std_string(cmplx), _get_filters(i), n)

    def getPatchComplexAmount(self, str patch, str cmplx, f):
        """
        Returns the amount (in mols) of complex with identifier string cmplx
        matching filter filt in patch with identifier string patch.

        In a mesh-based simulation this is the combined amount from all 
        tetrahedral elements in the patch.

        Syntax::
            
            getPatchComplexAmount(patch, cmplx, filt)
        ...
        """
        return self.ptr().getPatchComplexAmount(to_std_string(patch), to_std_string(cmplx), _get_filters(f))

    def setPatchComplexAmount(self, str patch, str cmplx, i, double a):
        """
        Set the amount (in mols) of complex with identifier string cmplx in state init
        in patch with identifier string patch.
        ...
        Syntax::
            ...
            setPatchComplexAmount(patch, cmplx, init, amount)
        ...
        """
        self.ptr().setPatchComplexAmount(to_std_string(patch), to_std_string(cmplx), _get_filters(i), a)

    def getPatchComplexSUSCount(self, str patch, str cmplx, f, uint m):
        """
        Returns the number of subunits in state m of a complex with identifier string cmplx
        matching filter filt in patch with identifier string patch.
        ...
        Syntax::
            ...
            getPatchComplexCount(patch, cmplx, filt, m)
        ...
        """
        return self.ptr().getPatchComplexSUSCount(to_std_string(patch), to_std_string(cmplx), _get_filters(f), m)
    ...
    def getPatchComplexSReacExtent(self, str patch, str r):
        """
        Return the extent of complex reaction with identifier string reac in patch with 
        identifier string patch, that is the number of times the complex reaction has occurred up 
        to the current simulation time. 

        Note: in a mesh-based simulation (i.e. Tetexact), returns the sum of the complex reaction 
        extents in all tetrahedral elements of the patch.
        ...
        """
        return self.ptr().getPatchComplexSReacExtent(to_std_string(patch), to_std_string(r))
...
# ----------------------------------------------------------------------------------------------------------------------
    ...
    def getTriVDepSReacK(self, index_t idx, str vsr):
        """
        Returns the macroscopic reaction rate of voltage-dependent surface reaction with identifier string vsreac in triangular
        element with index idx. 

        Syntax::

            getTriVDepSReacK(idx, reac)
        ...
        """
        return self.ptr().getTriVDepSReacK(triangle_global_id(idx), to_std_string(vsr))
