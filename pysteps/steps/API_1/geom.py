...
class EndocyticZone(stepslib._py_EndocyticZone):
    """
    Annotation of a group of triangles in a Tetmesh (which must all belong to the
    same TmPatch). This group defines a 'zone' in which Endocytosis occurs. By
    default all endocytosis events are active in this zone, but they can be
    deactivated by solver controls.
    """
    pass
