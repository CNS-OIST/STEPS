...
class VolsysCreationTestCase(unittest2.TestCase):
...
class VolsysPropertyTestCase(unittest2.TestCase):
...
class VolsysReacTestCase(unittest2.TestCase):
    ...
    def testGetAllReacs(self):
        ...
        self.assertItemsEqual(stored_reacs, expected_reacs)

class VolsysDiffTestCase(unittest2.TestCase):
...
class VolsysSpecTestCase(unittest2.TestCase):
