...
class ModelCreationTestCase(unittest2.TestCase):
...
class ModelSpecTestCase(unittest2.TestCase):
    ...
    def testGetAllSpecs(self):
        ...
        self.assertItemsEqual(stored_specs, expected_specs)

class ModelChanTestCase(unittest2.TestCase):
    ...
    def testGetAllChans(self):
        ...
        self.assertItemsEqual(stored_chans, expected_chans)
        
class ModelVolsysTestCase(unittest2.TestCase):
    ...
    def testGetAllVolsyss(self):
        ...
        self.assertItemsEqual(stored_vsyss, expected_vsyss)

class ModelSurfsysTestCase(unittest2.TestCase):
    ...
    def testGetAllSurfsyss(self):
        ...
        self.assertItemsEqual(stored_ssyss, expected_ssyss)
