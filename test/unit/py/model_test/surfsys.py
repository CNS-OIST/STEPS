...
class SurfsysCreationTestCase(unittest2.TestCase):
...
class SurfsysPropertyTestCase(unittest2.TestCase):
...
class SurfsysSReacTestCase(unittest2.TestCase):
    ...
    def testGetAllSReacs(self):
        ...
        self.assertItemsEqual(stored_sreacs, expected_sreacs)

class SurfsysDiffTestCase(unittest2.TestCase):
    ...
    def testGetAllDiffs(self):
        ...
        self.assertItemsEqual(stored_diffs, expected_diffs)

def suite():
    all_tests = []
    all_tests.append(unittest2.makeSuite(SurfsysCreationTestCase, "test"))
    all_tests.append(unittest2.makeSuite(SurfsysPropertyTestCase, "test"))
    all_tests.append(unittest2.makeSuite(SurfsysSReacTestCase, "test"))
    all_tests.append(unittest2.makeSuite(SurfsysDiffTestCase, "test"))
