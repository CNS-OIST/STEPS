...
class TetmeshCreationTestCase(unittest2.TestCase):
...
def suite():
    all_tests = []
    all_tests.append(unittest2.makeSuite(TetmeshCreationTestCase, "test"))
    all_tests.append(unittest2.makeSuite(TetmeshComponentTestCase, "test"))
