...
class ChanCreationTestCase(unittest.TestCase):
...
class ChanPropertyTestCase(unittest.TestCase):
...
class ChanStateTestCase(unittest.TestCase):
    """ ChanState tests. """
    def setUp(self):
        self.model = Model()
    ...
    def testGetAllChanStates(self):
        ...
        self.assertCountEqual(stored_states, expected_states)
