...
class MultiVolsysTestCase(unittest2.TestCase):
    """ 
    ...
    def _runTest(self, solver):
        solver.setCompCount('comp1', 'A', 100000)
        solver.setCompCount('comp1', 'B', 100000)
        solver.setCompCount('comp2', 'D', 100000)
        solver.setCompCount('comp2', 'E', 100000)
        solver.run(1)
        if __name__ == "__main__":
            print("")
            print("A:", solver.getCompCount("comp1", "A"))
            print("B:", solver.getCompCount("comp1", "B"))
            print("C:", solver.getCompCount("comp1", "C"))
            print("D:", solver.getCompCount("comp2", "D"))
            print("E:", solver.getCompCount("comp2", "E"))
            print("F:", solver.getCompCount("comp2", "F"))
        self.assertNotEqual(solver.getCompCount("comp1", "C"), 0)
        self.assertNotEqual(solver.getCompCount("comp2", "F"), 0)
        self.assertEqual(solver.getCompCount("comp1", "A"), solver.getCompCount("comp1", "B"))
        self.assertEqual(solver.getCompCount("comp1", "A") + solver.getCompCount("comp1", "C"), 100000)
        self.assertEqual(solver.getCompCount("comp2", "D"), solver.getCompCount("comp2", "E"))
        self.assertEqual(solver.getCompCount("comp2", "D") + solver.getCompCount("comp2", "F"), 100000)
...
class MultiSurfsysTestCase(unittest2.TestCase):
    """ 
    ...
    def _runTest(self, solver):
        solver.setPatchCount('patch1', 'A', 100000)
        solver.setPatchCount('patch1', 'B', 100000)
        solver.setPatchCount('patch2', 'D', 100000)
        solver.setPatchCount('patch2', 'E', 100000)
        solver.run(1)
        if __name__ == "__main__":
            print("")
            print("A:", solver.getPatchCount("patch1", "A"))
            print("B:", solver.getPatchCount("patch1", "B"))
            print("C:", solver.getPatchCount("patch1", "C"))
            print("D:", solver.getPatchCount("patch2", "D"))
            print("E:", solver.getPatchCount("patch2", "E"))
            print("F:", solver.getPatchCount("patch2", "F"))
        self.assertNotEqual(solver.getPatchCount("patch1", "C"), 0)
        self.assertNotEqual(solver.getPatchCount("patch2", "F"), 0)
        self.assertEqual(solver.getPatchCount("patch1", "A"), solver.getPatchCount("patch1", "B"))
        self.assertEqual(solver.getPatchCount("patch1", "A") + solver.getPatchCount("patch1", "C"), 100000)
        self.assertEqual(solver.getPatchCount("patch2", "D"), solver.getPatchCount("patch2", "E"))
        self.assertEqual(solver.getPatchCount("patch2", "D") + solver.getPatchCount("patch2", "F"), 100000)
...
def suite():
    all_tests = []
    all_tests.append(unittest2.makeSuite(MultiVolsysTestCase, "test"))
    all_tests.append(unittest2.makeSuite(MultiSurfsysTestCase, "test"))
