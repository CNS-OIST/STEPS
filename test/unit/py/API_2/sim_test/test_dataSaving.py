...
class SimDataSaving(base_model.TestModelFramework):
    ...
    def testDeltaTSavingDB(self):
        _, dbPath = tempfile.mkstemp(prefix=f'{self.__class__.__name__}testDeltaTSaving', suffix='.db')
    ...
    def testFileSavingDB(self):
        ...
        self.simulateAndCompare(*params, dbPath, dbdct)
    ...
    def testDBSaving(self):
        _, dbPath = tempfile.mkstemp(prefix=f'{self.__class__.__name__}testDBSaving', suffix='.db')
