...
from ..base_model import DistTetTestModelFramework


class DistTetOpSplitSimDataSaving(DistTetTestModelFramework, TetSimDataSaving):
    """Test data access, setting, and saving with tetmeshes."""

    def setUp(self):
        DistTetTestModelFramework.setUp(self)
