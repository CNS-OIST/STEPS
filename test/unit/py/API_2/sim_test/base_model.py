...
class TetTestModelFramework(TestModelFramework):
    ...
    def get_API1_Mdl(self):
        ...
        ss1RVDep01_fwd = smodel.VDepSReac('ss1RVDep01_fwd', omdl.getSurfsys('ssys'), slhs=[chancl], srhs=[chanop], k=self.rvdep01f._func, vrange=self.rvdep01f.vrange)
        ss1RVDep01_bkw = smodel.VDepSReac('ss1RVDep01_bkw', omdl.getSurfsys('ssys'), srhs=[chancl], slhs=[chanop], k=self.rvdep01b._func, vrange=self.rvdep01b.vrange)
    ...
    def get_API2_Geom(self, nmdl):
        ...
        nmesh = TetMesh.Load(os.path.join(FILEDIR, 'meshes', 'cyl_len10_diam1'), name='nmesh')
