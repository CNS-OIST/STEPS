...
class tetMeshTests(unittest.TestCase):
    ...
    def testLoading(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            meshPath = os.path.join(tmpdir, 'meshName')
            mesh.Save(meshPath)
    ...
    def testCompartments(self):
        ...
        sim = Simulation('Wmdirect', self.model, self.mesh, rng)
    ...
    def testPatches(self):
        ...
        c1lst = TetList([tet for tet in self.mesh.tets if tet.center.x >= 0], self.mesh)
