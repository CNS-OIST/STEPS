...
# AIMS: to verify STEPS well-mixed stochastic solver 'Tetexact' computes 
...
class TestRDSpatialTetexact(unittest.TestCase):

    def test_spatial_tetexact(self):
    ...
    ##################### First order irreversible #########################
        ...
        "Reaction - First order, irreversible (Tetexact)"
    ...
    ####################### First order reversible #########################
        ...
        "Reaction - First order, reversible (Tetexact)"
    ...
    ####################### Second order irreversible A2 ###################
        ...
        "Reaction - Second order, irreversible, 2A->C (Tetexact)"
    ...
    ####################### Third order irreversible A3 ###################
        ...
        "Reaction - Third order, irreversible, 3A->C (Tetexact)"
    ...
    ####################### Third order irreversible A3 ###################
        ...
        "Reaction - Third order, irreversible, 2A+B->C (Tetexact)"
    ...
    ####################### Second order irreversible AA ###################
        ...
        "Reaction - Second order, irreversible, A0=B0 (Tetexact)"
    ...
    ########################################################################
        ...
        "Reaction - Second-order, irreversible, 2D (Tetexact)"
