...
# AIMS: to verify STEPS well-mixed stochastic solver 'Wmrssa' computes 
...
class TestRDWellMixedRSSA(unittest.TestCase):

    def test_well_mixed_rssa(self):
        ...
        CCST_so2d = KCST_so2d/(Avogadro*AREA_so2d)
        ...
        with geom:
            ...
            patch1 = Patch.Create(comp1, None, surfsys, AREA_so2d)
    ...
    ##################### First order irreversible #########################
        ...
        "Reaction - First order, irreversible (Wmrssa)"
    ...
    ####################### First order reversible #########################
        ...
        "Reaction - First order, reversible (Wmrssa)"
    ...
    ####################### Second order irreversible A2 ###################
        ...
        "Reaction - Second order, irreversible, 2A->C (Wmrssa)"
    ...
    ####################### Third order irreversible A3 ###################
        ...
        "Reaction - Third order, irreversible, 3A->C (Wmrssa)"
    ...
    ####################### Third order irreversible A3 ###################
        ...
        "Reaction - Third order, irreversible, 2A+B->C (Wmrssa)"
    ...
    ####################### Second order irreversible AA ###################
        ...
        "Reaction - Second order, irreversible, A0=B0 (Wmrssa)"
    ...
    ########################################################################
        ...
        "Reaction - Second-order, irreversible, 2D (Wmrssa)"
