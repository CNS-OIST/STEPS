...
class TestRDMPISpatialTetopsplit(unittest.TestCase):

    def test_spatial_tetOpsplit(self):
...
def suite():
    all_tests = []
    all_tests.append(unittest.TestLoader().loadTestsFromTestCase(TestRDMPISpatialTetopsplit))
