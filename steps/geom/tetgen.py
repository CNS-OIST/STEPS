...
import steps.geom.tetmesh as stetmesh
...
def read(pathroot, compmap = None, patchmap = None, patchiomap = None):
    ...
    # First line is: <# of points> <dimension (3)> <# of attributes>
    ...
    for nodeno in xrange(0, nnodes):
        ...
        # Remaing lines: <point #> <x> <y> <z> [attributes] 
        #                [boundary marker]
        tokens = line.split()
        if len(tokens) == 0: 
            continue
    ...
    if (len(comps) > 0) and (compmap != None):
        ...
        for i in uniqcomps:
            ...
            newcomp = stetmesh.Comp(compmap[i], tetmesh, alltets)
        ...
        if (len(patches) > 0) and (patchmap != None) and (patchiomap != None):
            ...
            for i in uniqpatches:
                ...
                if ocomp_n != None:
                    ...
                    assert ocomp != None
                np = stetmesh.Patch(patch_n, tetmesh, alltris, icomp, ocomp)
