...
macro(FIND_PACKAGE_MULTIPASS _name _current)
  ...
  if(NOT ${_stored})
    set(${_stored}
        "YES"
        CACHE BOOL "Is the configuration for ${_name} current?  Set to \"NO\" to reconfigure."
              FORCE)
    set(_states_current "NO")
  endif(NOT ${_stored})
  ...
  set(PACKAGE_MULTIPASS_${name}_CALLED
      YES
...
macro(MULTIPASS_SOURCE_RUNS includes libraries source runs language)
  ...
  # This is a ridiculous hack.  CHECK_${language}_SOURCE_* thinks that if the *name* of the return
  # variable doesn't change, then the test does not need to be re-run.  We keep an internal count
  # which we increment to guarantee that every test name is unique.  If we've gotten here, then the
  # configuration has changed enough that the test *needs* to be rerun.
