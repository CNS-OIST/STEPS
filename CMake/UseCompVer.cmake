...
function(get_gcc_version language ver_name)
  if(CMAKE_${language}_COMPILER_ID STREQUAL GNU)
    ...
    exec_program(
      ${CMAKE_${language}_COMPILER} ARGS
      ${CMAKE_${language}_COMPILER_ARG1} -dumpversion
...
function(get_gcc_patch language ver_name)
  if(CMAKE_${language}_COMPILER_ID STREQUAL GNU)
    ...
    exec_program(
      ${CMAKE_${language}_COMPILER} ARGS
      ${CMAKE_${language}_COMPILER_ARG1} --version
      OUTPUT_VARIABLE _version)
...
function(get_ld_version ver_name)
  # run linker to get the version number. interestingly, this option works (for our purposes) on all
  # major platforms (Linux, Mac OS X and Windows); it returns the program version although it may
  # have ended in error
  exec_program(
    ${CMAKE_LINKER} ARGS
    "-v"
  ...
  if(NOT WIN32)
    if(APPLE)
      ...
      string(REGEX REPLACE "GNU ([a-zA-Z0-9_]*) (version|\\(.*\\)) ([^\\ ]*).*" "\\1 \\3" _version
                           "${_version}")
    endif(APPLE)
  endif(NOT WIN32)
